...
function cardBinInfo(){
    ...
    $response = YopClient3::post("/rest/v1.0/payplus/config/dict/cardBinInfo", $request);
	  // var_dump($response);
	...
	<body>	
		...
		<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
			...
			<tr>
				...
				<tr >
				<td width="25%" align="left">&nbsp;卡 BIN 信息</td>
				<td width="5%"  align="center"> : </td> 
				<td width="45"  align="left"><textarea cols="70" rows="1">  <?php  if (empty($result['data'])) {echo "";} else {echo preg_replace("#\\\u([0-9a-f]{4})#ie", "iconv('UCS-2BE', 'UTF-8', pack('H4', '\\1'))", json_encode($result['data'])), "\n";  }?>  </textarea></td>
