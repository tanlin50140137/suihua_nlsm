...
function queryBindCardList(){
    ...
    $response = YopClient3::post("/rest/v1.0/payplus/user/queryBindCardList", $request);
	 // var_dump($response);
	...
	<body>	
		...
		<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
			...
			<tr>
				...
				<td width="5%"  align="center"> : </td> 
				<td width="45"  align="left"><textarea cols="70" rows="10">  <?php  if (empty($result['cardList'])) {echo "";} else {echo preg_replace("#\\\u([0-9a-f]{4})#ie", "iconv('UCS-2BE', 'UTF-8', pack('H4', '\\1'))", json_encode($result['cardList'])), "\n";  }?>  </textarea></td>
