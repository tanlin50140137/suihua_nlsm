...
function payRefundQuery()
{
    ...
    $response = YopClient3::post("/rest/v1.0/payplus/refund/query", $request);
    $data=(array)$response;
    $result=$data['result'];
...
<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
   ...
   <tr >
				<td width="35%" align="left">&nbsp;退款订单详情</td>
				<td width="5%"  align="center"> : </td> 
				<td width="45"  align="left"><textarea cols="70" rows="10">  <?php  if (empty($result['refundOrderList'])) {echo "";} else {echo preg_replace("#\\\u([0-9a-f]{4})#ie", "iconv('UCS-2BE', 'UTF-8', pack('H4', '\\1'))", json_encode($result['refundOrderList'])), "\n";  }?>  </textarea></td>
				 
				 <td width="5%"  align="center"> - </td> 
				<td width="20%" align="left">refundOrderList</td> 
			</tr>
