...
//转账
function merchantBatchTransfer(){
    ...
    $request->addParam("transferList", $_REQUEST['transferList']);
 


    $response = YopClient3::post("/rest/v1.0/payplus/transfer/merchantBatchTransfer", $request);
//	var_dump($response);
