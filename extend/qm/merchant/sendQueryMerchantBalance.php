...
function queryMerchantBalance(){
    ...
    $response = YopClient3::post("/rest/v1.0/payplus/merchant/queryMerchantBalance", $request);
	 // var_dump($response);
