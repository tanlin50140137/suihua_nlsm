...
function querySubMerchantStatus(){
    ...
    $response = YopClient3::post("/rest/v1.0/payplus/merchant/querySubMerchantStatus", $request);
	 // var_dump($response);
	...
	<body>	
		...
		<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
			...
			<tr>
				...
				<tr >
				<td width="25%" align="left">&nbsp;入网状态查询结果</td>
				<td width="5%"  align="center"> : </td> 
